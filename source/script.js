...
idForm.addEventListener("submit",(event) => {
  console.log("Gracias por tu consulta")
  let idPref = document.querySelector("#idPref").value
  let idZona = document.querySelector("#idZona").value
  let idAmbientes = document.querySelector("#idAmbientes").value

  console.log(idPref)
  console.log(idZona)
  console.log(idAmbientes)
})

/*
propiedades.forEach((propiedades, indice) => {
  document.querySelector("#boton${indice}").addEventListener("click", () => {
    console.log(document.querySelector("#propiedades${indice}"))
  })
  let productoCarrito = propiedades[indice]
  productoCarrito.push(productoCarrito)
